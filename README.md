...
- **Bespoke Glassmorphism Design**: A custom UI crafted with Tailwind CSS v4 featuring a floating pill navigation bar, intelligent dark/light mode switching, and a refined typographic hierarchy utilizing JetBrains Mono.
...
- **CMS Integration**: @notionhq/client, react-notion-x
